 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://crowdcode.de/jaxws", wsdlLocation = "file:/Users/idueppe/git/jaxws-course-examples/examples/simple-annotated/src/test/resources/wsdl/CalculatorService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://crowdcode.de/jaxws", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/idueppe/git/jaxws-course-examples/examples/simple-annotated/src/test/resources/wsdl/CalculatorService.wsdl");
     ...
     *     returns Calculator
     */
    @WebEndpoint(name = "CalculatorBeanPort")
    public Calculator getCalculatorBeanPort() {
        return super.getPort(new QName("http://crowdcode.de/jaxws", "CalculatorBeanPort"), Calculator.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculatorBeanPort")
    public Calculator getCalculatorBeanPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://crowdcode.de/jaxws", "CalculatorBeanPort"), Calculator.class, features);
    }
